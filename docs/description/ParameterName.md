...
[CatchParameterName](https://checkstyle.org/checks/naming/catchparametername.html).

To validate lambda parameters please use
[LambdaParameterName](https://checkstyle.org/checks/naming/lambdaparametername.html).
